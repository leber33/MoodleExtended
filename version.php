...
$plugin->component = "local_cohortenrol";
$plugin->version  = 2015120803;   // The (date) version of this module + 2 extra digital for daily versions
...
//$plugin->requires = 201112400;  // Requires this Moodle version - at least 2.0
$plugin->cron     = 0;
$plugin->release = '1.0';
